...
def loginMobileClientFromCache(mcw, oauth_filename='oauth'):
	# mcw is MobileClientWrapper
	print("loginMobileClient")
...
def main():
	...
	loginMobileClientFromCache(mcw, oauth_filename=cli['cred'])
	...
	if cli['down']:
		...
		logger.info("\nUploading and Syncing playlists not yet supported")
